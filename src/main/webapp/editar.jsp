...
<body>
	<h1>Editar Atleta</h1>
	<form name="frmAtleta" action="update">
		<fieldset>
			<legend>INFORMAÇÕES DO ATLETA</legend>
			<p></p>
			<label for="nome">Nome:</label><br> <input type="text" id="nome"
				name="nome"><br> <br> <label for="categoria">Categoria:</label><br>
			<input type="text" id="categoria" name="categoria"><br>
			<br> <label for="total">Total:</label><br> <input
				type="text" id="total" name="total"><br> <br>
		</fieldset>
		<p></p>
